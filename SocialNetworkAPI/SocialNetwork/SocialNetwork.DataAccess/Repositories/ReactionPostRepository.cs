...
namespace SocialNetwork.DataAccess.Repositories
{
    public class ReactionPostRepository : BaseRepository<ReactionPostEntity>, IReactionPostRepository
    {
        ...
        public async Task DeleteReactionAsync(string reactionId, string postId)
        {
        ...
        public async Task<IEnumerable<ReactionPostEntity>> GetReactionsByPostIdAsync(string postId)
        {
